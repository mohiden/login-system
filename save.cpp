...
/*
my name is mohiden and i love programming and tech stuff i am curently 20 in my second year at college and i created this simple login system, feel free to use it.
Name      : LOGIN SYSTEM
Author    : MOHIDEN ABDULKARIM
Coded By  : MOHIDEN ABDULKARIM
Date      : october 2019 - 10/10/2019



CONTACT 
if you would like to contact with me about anything feel free  here is my soical media accounts.
Email : mohidenabdi@gmail.com
instagram : mohiden_
twitter : mohiden7
facebook : mohiden abdulkarim



NOTE : 
1 - to run this code u need to run it using c++11 , its easy just follow the steps 
...
2 - now i am using txt file as database
  when you register the txt file will be created on the same path where your source code is.
...
// class Login
// {
//   // function varibels are all private
...
// std::string getpas(std::string pas){    //Makes password appear as ******
...
//    password = login.getpas(password);
//     // std::cout<<"\n"<<password<<std::endl;
